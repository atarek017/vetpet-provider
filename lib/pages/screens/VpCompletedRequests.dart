...
class VpCompletedRequests extends StatefulWidget {
  @override
...
class _completedRequests extends State<VpCompletedRequests> {
  ...
  init() async {
    ...
    requestsFuture =
        requestRepo.getCompletedRequests(ActiveRequestBody(provid: providerId));
    _activeRequestsState = ActiveRequestsState.activeList;
